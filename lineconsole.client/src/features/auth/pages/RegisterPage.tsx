...
const schema: yup.ObjectSchema<RegisterFormData> = yup.object({
    ...
    channelToken: yup.string().required("Access Token 為必填"),
});
...
export default function RegisterPage() {
    ...
    const transformToRegisterInput = (form: RegisterFormData): RegisterInput => ({
        ...
        lineAccount: {
            ...
            channelAccessToken: form.channelToken,
        },
    });
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        {step === 1 ? (
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="channelToken">Access Token</Label>
                                    <Textarea id="channelToken" {...register("channelToken")} />
                                    <p className="text-sm text-destructive min-h-[20px]">
                                        {errors.channelToken?.message ?? "\u00A0"}
                                    </p>
                                </div>
